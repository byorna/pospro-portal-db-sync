...
def sync_data(cursor_source, cursor_target, source_schema, source_table, target_table, columns, id_column, table_as_is, column_as_is,
    ...
    comparable_columns = filter_comparable_columns(cursor_source, source_schema, source_table, columns)
...
def sync(json_file, mssql_pool, mysql_pool):
    ...
    for table in sync_config['tables']:
        ...
        if column_as_is == 1:
            columns = get_source_columns(cursor_mssql, source_schema, source_table)
        ...
        check_and_create_columns(cursor_mssql, cursor_mysql, source_schema, source_table, target_table, columns, table_as_is,
                                 column_as_is, target_id)
        sync_data(cursor_mssql, cursor_mysql, source_schema, source_table, target_table, columns, id_column, table_as_is, column_as_is,
...
def check_and_create_columns(cursor_source, cursor_target, source_schema, source_table, target_table, columns, table_as_is, column_as_is, target_id):
    ...
    print("source_columns_query:", source_columns_query)
